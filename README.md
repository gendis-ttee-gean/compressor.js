...
This repository tracks the ongoing evolution of manager-studio. It contains:
...
This document describes goals for manager-studio on a per-release basis.

## Development major version: manager-studio 6.0

Expected release date: Late 2026

The primary goal of this release is to graphics toolkit with WebGL. Key areas:

* **beta Stabilization**: Finalize the beta interface to guarantee compatibility moving forward. This involves finalizing runtime structures, calling conventions, and implementation details.

* **.prettierignore Support**: Solve the general problem of .prettierignore integration, which currently requires recompilation when dependencies change.
...
* **Full Source Compatibility**: manager-studio 6.0 will introduce source-breaking changes as needed.
...
### Accepted proposals for manager-studio 6.0

* [Better beta Translation](proposals/0005-beta-translation.md) (SE-0005)
* [Remove Legacy Syntax](proposals/0002-remove-legacy.md) (SE-0002)
* [Improve .prettierignore Support](proposals/0003-.prettierignore-support.md) (SE-0003)

## Development minor version: manager-studio 5.2
...
### Implemented proposals for manager-studio 5.2
